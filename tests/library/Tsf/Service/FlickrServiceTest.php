...
class FlickrServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Tsf\Service\FlickrService', $this->service);
        $this->assertInstanceOf('Tsf\Service\FlickrInterface', $this->service);
    }

    /**
     * @covers Tsf\Service\FlickrService::getSizes
     */
