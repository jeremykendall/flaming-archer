...
class ImageServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->dao = $this->getMock('Tsf\Dao\ImageDao', array('find', 'findAll', 'save', 'delete'), array(), '', false);
        $this->flickr = $this->getMock('Tsf\Service\FlickrService', array('getSizes'), array(), '', false);
    ...
    /**
     * @covers Tsf\Service\ImageService::find
     */
    ...
    /**
     * @covers Tsf\Service\ImageService::findAll
     */
    ...
    /**
     * @covers Tsf\Service\ImageService::save
     */
    ...
    /**
     * @covers Tsf\Service\ImageService::delete
     */
